#!/bin/bash
#
# The purpose of this script is to disable, delete and/or archive users on the system.
...
echo ' -a Creates an archive of the home directory associqted with the account(s).' >&2
exit 1
}
